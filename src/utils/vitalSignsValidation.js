...
/**
 * Obtiene los estilos CSS de validación según el nivel
 * @param {string} level - Nivel de validación ('normal', 'warning', 'critical', 'error', 'default')
 * @returns {Object} Objeto con clases CSS de Tailwind
 */
export function getValidationStyles(level) {
  const styles = {
    normal: {
