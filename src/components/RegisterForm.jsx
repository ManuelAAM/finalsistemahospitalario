...
export default function RegisterForm({ onRegisterSuccess, onBackToHome }) {
  ...
  const handleSubmit = async (e) => {
    ...
    // RT-02: Validar requisitos de contraseña
    ...
    <div style={{ 
      ...
      <div className="bg-white rounded-3xl shadow-2xl w-full p-8 relative animate-scaleIn max-h-[95vh] overflow-y-auto" style={{ maxWidth: '360px' }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={isLoading || !validatePassword(formData.password).isValid}
          ...
          >
            {isLoading ? (
              ...
              validatePassword(formData.password).isValid ? 'Crear Cuenta' : 'Completa los requisitos de seguridad'
            )}
          </button>
        </form>
