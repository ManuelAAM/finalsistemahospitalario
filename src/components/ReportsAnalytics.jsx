...
import { FileText, Activity, Pill, User, AlertCircle } from 'lucide-react';
             ...
             <div className="flex items-start gap-3">
               ...
               <div>
                 <p className="text-sm font-bold text-amber-800 mb-1">
                   🔒 Expediente Protegido por NOM-004-SSA3-2012
                 </p>
                 <p className="text-xs text-amber-700">
                   Todos los registros son <strong>permanentes y no pueden eliminarse</strong>. 
                   La integridad del expediente clínico está garantizada por ley para trazabilidad legal.
                 </p>
               </div>
             </div>
           </div>
